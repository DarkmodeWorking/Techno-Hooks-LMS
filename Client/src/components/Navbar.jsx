import { Menu, School, University, UniversityIcon, Webhook } from 'lucide-react'
  ...
  return (
    <div className='h-16 border-b bg-background dark:border-b-secondary border-b-secondary fixed top-0 left-0 right-0 duration-300 z-50'>
        ...
        <div className='flex text-primary items-center gap-2'>
          <Webhook size={'30'} />
          <Link to='/'>
            <h1 className='text-black dark:text-white hidden md:block font-extrabold text-2xl'>Techno Hooks</h1>
          </Link>     
        </div>
      ...
      <div className='flex md:hidden items-center justify-between px-4 h-full'>
        <div className='flex text-primary items-center gap-2'>
          <Webhook size={30} />
          <Link to='/'>
            <h1 className='text-black dark:text-white font-extrabold text-2xl'>Techno Hooks</h1>
          </Link>     
        </div>
        <MobileNavbar />
      </div>
