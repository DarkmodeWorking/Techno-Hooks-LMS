...
const SearchResult = ({course}) => {
  return (
    <div className='flex flex-col md:flex-row justify-between items-start md:items-center border-b-secondary py-4 gap-4'>
			<Link to={`/course-detail/${course._id}`} className='flex flex-col md:flex-row gap-4 w-full md:w-auto'>
				...
				<div className='flex flex-col gap-2'>
					...
					<p className='text-sm'>Course Instructor <span className='font-bold text-primary'>{course.creator.name}</span> </p>
