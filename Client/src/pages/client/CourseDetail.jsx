...
import { useGetCourseDetailWithStatusQuery } from '@/store/api/purchaseAPI'
  ...
  return (
    <div className='mt-20 space-y-5'>
			<div className='max-w-7xl mx-auto py-8 px-4 md:px-8 flex flex-col gap-2'>
				...
				<p>Created by <span className='text-primary'>{course?.creator.name}</span></p>
				<div className='flex items-center gap-2 text-sm'>
					<BadgeInfo size={16} />
					<p>Last updated <span className='underline'>{course?.createdAt.split("T")[0]}</span></p>
				</div>
