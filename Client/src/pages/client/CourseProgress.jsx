  ...
  return (
    <div className='max-w-7xl mx-auto p-4 mt-20'>
      ...
      <div className='flex flex-col md:flex-row gap-6'>
        ...
        <div className='w-full md:w-2/5 flex-none h-[500px] border-t md:border-t-0 md:border-l border-secondary md:pl-4 pt-4 md:pt-0'>
          <h2 className='font-semibold text-xl mb-4'>Course Lectures</h2>
          <div className='h-[500px] overflow-y-auto rounded-lg border p-5 shadow-lg scrollbar'>
            {courseDetails?.lectures.map((lecture) => (
              <Card
                key={lecture._id}
                className={`mb-3 hover:cursor-pointer transition transform ${
                  lecture._id === currentLecture?._id ? 'bg-border' : 'bg-card'
                }`}
