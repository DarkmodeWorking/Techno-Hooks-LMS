...
import { useGetSearchCourseQuery } from '@/store/api/courseAPI'
...
const SearchPage = () => {
  ...
  return (
    <div className='max-w-7xl mx-auto p-4 md:p-8 mt-5'>
			<div className='my-6'>
				<h1 className='font-bold text-xl md:text-2xl'>Searching {query}</h1>
				<p>
					Showing results for {' '}
...
const CourseSkeleton = () => {
  return (
    <div className="flex-1 flex flex-col md:flex-row justify-between border-b border-secondary py-4">
